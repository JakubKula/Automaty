...
<form:form method="post" modelAttribute="vendingDelivery" action="/delivery/vending/delivery" cssClass="m-4 p-3 width-medium">
                ...
                <div col>
                    ...
                    <table cellspacing="0" cellpadding="0" border="0" style="width: 100%">
                        <tbody>
                            <tr>
                                <td rowspan="2">
                                    <h1 class="text-color-darker" align="center">Załadunek automatu</h1>
                                    <div class="form-group" align="center">
                                        ...
                                        <br>Automat<br>
                                        <form:select path="vending" items="${vendings}" itemLabel="addressNumber"  itemValue="id"  id="select"/>
                                        <form:errors path="vending"/>
                                        <br>Wybrany samochód: <br>
                                            ${car.markRegi}<br>
                                    </div>
                                    <div class="form-group" align="center">
