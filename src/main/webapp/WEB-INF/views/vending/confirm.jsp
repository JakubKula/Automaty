    ...
    <div class="m-4 p-3 border-dashed view-height">
        ...
        <div class="row border-bottom border-3 p-1 m-1">
            <div class="col noPadding">
                <h3 class="color-header text-uppercase">Czy na pewno chcesz usunąć ten vending?</h3>
            </div>
        ...
        <div class="schedules-content">
            ...
            <tbody class="text-dark-text">
                ...
                <td class="col-1">${param.address}</td>
                <td class="col-2">${param.mark}</td>
                <td class="col-3">${param.model}</td>
                <td class="col-3">${param.number}</td>

                <td><a href="/vending/all" class="btn btn-success ">Anuluj</a> </td>
                <td><a href="/vending/remove/${param.id}" class="btn btn-danger rounded-0 text-light m-1">Usuń</a></td>
                </tr>
            </tbody>
            </table>
        </div>
