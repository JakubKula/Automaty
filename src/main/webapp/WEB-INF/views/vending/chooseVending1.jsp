    ...
    <div class="container pt-4 pb-4">
        <div class="border-dashed view-height">
            <div class="container w-25">
                    <h1 class="text-color-darker">Na jakim automacie chcesz ustawić ceny?</h1>
                    <div class="form-group">
                        <form:form method="get" modelAttribute="vendingDelivery" action="/price/set/price" cssClass="m-4 p-3 width-medium">
