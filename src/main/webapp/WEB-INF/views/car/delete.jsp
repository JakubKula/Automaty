...
<form:form method="post" modelAttribute="delivery" action="/delivery/delete/car/product" cssClass="m-4 p-3 width-medium">
            ...
            <div align="flex-direction: column">
                <div col>
                    ...
                    <table cellspacing="0" cellpadding="0" border="0" style="width: 100%">
                        ...
                        <tr>
                            <td rowspan="2">
                                <h1 class="text-color-darker" align="center">Usunięcie produktu z samochodu</h1>
