    ...
    <div class="m-4 p-3 border-dashed view-height">
        ...
        <div class="row border-bottom border-3 p-1 m-1">
            <div class="col noPadding">
                <h3 class="color-header text-uppercase">Czy na pewno chcesz usunąć ten samochód?</h3>
            </div>
        ...
        <div class="schedules-content">
            ...
            <tbody class="text-dark-text">
                ...
                <td class="col-4">${param.registration}</td>

                <td><a href="/car/all" class="btn btn-success ">Anuluj</a> </td>
                <td><a href="/car/remove/${param.id}" class="btn btn-danger rounded-0 text-light m-1">Usuń</a></td>
                </tr>
            </tbody>
            </table>
        </div>
