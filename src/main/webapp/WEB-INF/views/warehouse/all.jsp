        ...
        <div class="m-4 p-3 border-dashed view-height">
            ...
            <div class="row border-bottom border-3 p-1 m-1">
                <div class="col noPadding">
                    <h3 class="color-header text-uppercase">Magazyny</h3>
                </div>
                ...
                <table class="table">
                    ...
                    <c:forEach var="warehouses" items="${warehouses}" >
                        <tr class="d-flex">
                            ...
                            <td><a href="/warehouse/edit/${warehouses.id}" class="btn btn-danger rounded-0 text-light m-1">Edytuj</a> </td>
                            <td><a href="/warehouse/confirm?id=${warehouses.id}&address=${warehouses.address}&name=${warehouses.name}" class="btn btn-danger rounded-0 text-light m-1">Usuń</a> </td>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
